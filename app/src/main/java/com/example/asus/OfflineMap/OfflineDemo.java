...
public class OfflineDemo extends Activity implements
	...
	private void initView() {
		...
		ListAdapter hAdapter = new ArrayAdapter<String>(this,
				R.layout.offline_list_item, hotCities);
		...
		ListAdapter aAdapter =  new ArrayAdapter<String>(this,
				R.layout.offline_list_item, allCities);
